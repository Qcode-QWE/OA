...
<form action="${pageContext.request.contextPath}/reply/replyAction_find.action">
	<s:hidden name="topic.topicId" value="%{topic.topicId}"></s:hidden>
	...
	<div id="PageHead"></div>
							...
							<td align="center">
								<ul class="TopicFunc">
									...
									<li class="TopicFuncLi">
										<a class="detail" href="${pageContext.request.contextPath}/reply/replyAction_show.action?reply.replyId=${replyId}">
											<img border="0" src="${pageContext.request.contextPath}/style/images/edit.gif" />查看该回帖
										</a>
									</li>
									<!-- 文章表情与标题 -->
		...
		<script type="text/javascript">
			function gotoPage( pageNum ){
				window.location.href = "replyAction_find.action?topic.topicId=${topic.topicId}&findName=${findName}&pageNum=" + pageNum;
			}
		</script>
		</s:if>
</div>
